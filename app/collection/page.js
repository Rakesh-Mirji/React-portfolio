...
export default function Collection(){
    ...
    <div className="p-10 overflow-hidden">
        <div className="w-screen p-5 flex justify-between items-center ">
            ...
            <h1 className="text-5xl pt-10 font-semibold">Projects</h1>
        ...
        <div className=" w-screen p-5 flex justify-between items-center ">
            <Image src={Bar} className="max-md:hidden"/>
            <h1 className="text-5xl pt-10 font-semibold">Minor Projects</h1>
            <div className="w-1/4 max-md:hidden"></div>
        </div>
        ...
        <div className="py-10 w-screen flex justify-between items-center ">
